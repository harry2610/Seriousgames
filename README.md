...
Test and Developement Requirements:
- Unity Hub and Unity Editor
- minimum 5 GB disc storage space
...
- In the opened Unity editor, go to file -> build settings. Then in the platform area, select Android. Also make sure that all secenes are included and that the HomeMenu-scene is the first scene in the list
